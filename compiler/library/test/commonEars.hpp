...
#define OP_GAIN_64 5
    ...
    bool
    hw_setGain(OPAMP_TypeDef *op, uint8_t gain)
    {
      bool result = true;
    ...
    initADC2(void)
    {
      ...
      ADC2->SQR1 = ((2 - 1) << ADC_SQR1_L_Pos) | (16 << ADC_SQR1_SQ1_Pos) // earRight RM0440 p392 t69
    ...
    initDMA(void)
    {
      ...
      DMA1_Channel1->CCR |= DMA_CCR_MINC | (0b10 << DMA_CCR_MSIZE_Pos) | (0b10 << DMA_CCR_PSIZE_Pos) | DMA_CCR_CIRC;
      DMA1_Channel1->CCR |= DMA_CCR_EN;
      DMAMUX1_Channel0->CCR |= (36 << DMAMUX_CxCR_DMAREQ_ID_Pos);
    }

    void
    initEars(uint8_t gain)
    {
      initADC_Common();
      initOPAMP2();
      initOPAMP3();
